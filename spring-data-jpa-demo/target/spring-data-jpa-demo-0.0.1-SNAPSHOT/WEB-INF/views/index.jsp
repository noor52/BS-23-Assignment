				...
				<div class="col-sm-12">
					<div class="card mb-2">
						<div class="card-body">
							...
							<p class="card-text">
								<a class="btn btn-success btn-lg btn-block" href="${pageContext.request.contextPath }/emp/add"
									role="button">ADD</a> <a
									class="btn btn-primary btn-lg btn-block"
									href="${pageContext.request.contextPath }/emp/show-all" role="button">SHOW ALL</a>
							</p>
						</div>

						<div class="card-body">
							<h4 class="card-title pb-3">salary</h4>
							<p class="card-text">
								<a class="btn btn-success btn-lg btn-block" href="${pageContext.request.contextPath }/salary/add"
								   role="button">ADD Basic Salary</a>
								<a
									class="btn btn-primary btn-lg btn-block"
									href="${pageContext.request.contextPath }/bank/add" role="button">Insert Bank Ballance Amount </a>
							</p>
						</div>
					</div>
				</div>
